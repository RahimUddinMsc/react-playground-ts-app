      ...
      >
        ...
        >
          {items.map((item: RadialMenuItem, index: number) => {
            ...
            const x1Inner = donutOuterRadius + donutInnerRadius * Math.cos(startRad);
            const y1Inner = donutOuterRadius + donutInnerRadius * Math.sin(startRad);
            const x2Inner = donutOuterRadius + donutInnerRadius * Math.cos(endRad);
            const y2Inner = donutOuterRadius + donutInnerRadius * Math.sin(endRad);
            
            const x1Outer = donutOuterRadius + donutOuterRadius * Math.cos(startRad);
            const y1Outer = donutOuterRadius + donutOuterRadius * Math.sin(startRad);
            const x2Outer = donutOuterRadius + donutOuterRadius * Math.cos(endRad);
            const y2Outer = donutOuterRadius + donutOuterRadius * Math.sin(endRad);
